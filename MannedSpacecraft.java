...
public class MannedSpacecraft extends Spaceships implements SpacecraftStructure{
    ...
    public void printFeatures() {
        ...
        MannedSpacecraft shuttle = generateSpacecraft();
    ...
    public MannedSpacecraft generateSpacecraft() {
        ...
        System.out.println("Ha seleccionado crear una Nave espacial tripulada");
        ...
        MannedSpacecraft newShuttleVehicle = new MannedSpacecraft(
                name,
                "Naves no tripuladas",
                nationality,
                power,
